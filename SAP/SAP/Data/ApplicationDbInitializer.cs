...
namespace SAP.Data
{
    public static class ApplicationDbInitializer
    {
        ...
        public static void SeedCatalogue(ApplicationDbContext dbContext)
        {
            ...
            var android = new Category { Id = Guid.Parse("22B45FB9-5F3E-42BE-1C61-08D749C970CF"), Name = androidCategory, Parent = smarts };
            ...
            var ios = new Category { Id = Guid.Parse("FDD9A56A-CD4E-4DC4-1C62-08D749C970CF"), Name = iOSCategory, Parent = smarts };
            ...
            var harmony = new Category { Id = Guid.Parse("36105B46-B52C-4EB1-1C63-08D749C970CF"), Name = harmonyCategory, Parent = smarts };
            ...
            var laptops = new Category { Name = laptopsCategoryName };
            dbContext.Categories.Add(laptops);
            var asus = new Category { Id = Guid.Parse("36105B46-B52C-4EB1-1C63-08D749C970FC"), Name = "ASUS", Parent = laptops };
            var acer = new Category { Id = Guid.Parse("36105B46-B52C-4EB1-1C63-08D749C970DA"), Name = "Acer", Parent = laptops };
            dbContext.Categories.Add(asus);
            dbContext.Categories.Add(acer);
